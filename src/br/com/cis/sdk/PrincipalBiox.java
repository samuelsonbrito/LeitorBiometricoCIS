...
public class PrincipalBiox extends javax.swing.JFrame {

    public interface CIS_SDK extends Library   
    {
    ...
    private void btnDedo1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDedo1ActionPerformed
        ...
        // Instanciar a DLL
        CisBioxSDK biox = new CisBioxSDK();
        
        int iRetorno = biox.CIS_SDK_Biometrico_Iniciar(); 
          if (iRetorno != 1) 
          {
    ...
    private static Runnable LerDigital1 = new Runnable() { 
        public void run() { 
            try{ 
                ...
                pDigital = biox.CIS_SDK_Biometrico_LerDigital_RetornoPonteiro(iRet);
                int iRetorno2 = iRet.getValue();
                  if (iRetorno2 != 1)
                  {
                    biox.CIS_SDK_Biometrico_Finalizar();   
                ...
                // Finalizar o SDK        
                int iRetorno = biox.CIS_SDK_Biometrico_Finalizar(); 
                    if (iRetorno != 1)
                    {
                        JOptionPane.showMessageDialog(null, "Erro: " + Integer.toString(iRetorno));              
                        return;
    ...
    private void btnCompararActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCompararActionPerformed
        ...
        try
        {
            ...
            iRetorno = biox.CIS_SDK_Biometrico_CompararDigital(pr1, pr2);
            if (iRetorno == 1)
            {   
       ...
       // Finalizar o SDK 
       iRetorno = biox.CIS_SDK_Biometrico_Finalizar(); 
          if (iRetorno != 1)
          {
            JOptionPane.showMessageDialog(null, "Erro: " + Integer.toString(iRetorno));              
            return;
    ...
    private void btnCancelarLeituraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCancelarLeituraActionPerformed
        ...
        // Cancelar a leitura 
        biox.CIS_SDK_Biometrico_CancelarLeitura(); 
...
private static Runnable LerWSQ = new Runnable() { 
        public void run() { 
            try{ 
                ...
                pImagem = biox.CIS_SDK_Biometrico_LerDigital_LerWSQ(iRet, iSize);
                int iRetorno2 = iRet.getValue();
                  if (iRetorno2 == 0)
                  {
                    return;
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PrincipalBiox.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PrincipalBiox().setVisible(true);
            }
        });
    }
